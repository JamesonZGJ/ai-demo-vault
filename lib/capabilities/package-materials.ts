...
const sourceFiles: Record<string, string> = {
  ...
  "agent-task-inbox": "src/AgentTaskInbox.tsx",
  "agent-execution-timeline": "src/AgentExecutionTimeline.tsx",
  "ai-diff-review": "src/AIDiffReview.tsx",
  "artifact-split-preview": "src/ArtifactSplitPreview.tsx",
  ...
  "memory-update-control": "src/MemoryUpdateControl.tsx",
  "multimodal-attachment-queue": "src/MultimodalAttachmentQueue.tsx",
  ...
  "source-citation-preview": "src/SourceCitationPreview.tsx",
  "tool-call-activity-card": "src/ToolCallActivityCard.tsx",
